  ...
  async insertReporteCredito(idCertification, data, customUuid) {
    try {
      ...
      const values = [
        ...
        `'${escapeSingleQuotes(_06_tiempo_actividad?.descripcion ?? '')}'`,
        `'${escapeSingleQuotes(_06_tiempo_actividad?.score ?? '')}'`,
        `'${escapeSingleQuotes(_08_ventas_anuales?.descripcion ?? '')}'`,
        ...
        _11_evolucion_ventas?.parametro !== undefined ? `'${escapeSingleQuotes(_11_evolucion_ventas.parametro)}'` : 'DEFAULT',
        `'${escapeSingleQuotes(_11_evolucion_ventas?.rango ?? '')}'`,
        `'${escapeSingleQuotes(_12_apalancamiento?.descripcion ?? '')}'`,
        ...
        _13_flujo_neto?.parametro !== undefined && _13_flujo_neto?.parametro !== '' ? `'${escapeSingleQuotes(_13_flujo_neto.parametro)}'` : "''",
        ...
        _14_payback?.descripcion !== undefined && _14_payback?.descripcion !== null && _14_payback?.descripcion !== '' ? `'${escapeSingleQuotes(_14_payback?.descripcion)}'` : "''",
        ...
        _15_rotacion_ctas_x_cobrar?.parametro_dso !== undefined ? `'${escapeSingleQuotes(_15_rotacion_ctas_x_cobrar.parametro_dso)}'` : 'DEFAULT',
        _15_rotacion_ctas_x_cobrar?.parametro_dio !== undefined ? `'${escapeSingleQuotes(_15_rotacion_ctas_x_cobrar.parametro_dio)}'` : 'DEFAULT',
        ...
        `'${escapeSingleQuotes(_16_referencias_comerciales?.descripcion ?? '')}'`,
        `'${escapeSingleQuotes(alertas?.descripcion_endeudamiento ?? '')}'`,
        alertas?.porcentaje_endeudamiento !== undefined ? alertas.porcentaje_endeudamiento : 'DEFAULT',
        `'${escapeSingleQuotes(alertas?.texto_reporte_endeudamiento ?? '')}'`,
        alertas?.dias_plazo_credito !== undefined ? alertas.dias_plazo_credito : 'DEFAULT',
        `'${escapeSingleQuotes(alertas?.texto_reporte_plazo_credito ?? '')}'`,
        `'${escapeSingleQuotes(score ?? '')}'`,
        `'${escapeSingleQuotes(wording_underwriting ?? '')}'`,
        `'${dpo}'`
      ];
